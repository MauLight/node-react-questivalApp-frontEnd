        ...
        <div className="flex flex-col w-full items-center h-full">
          <motion.h1
            ...
            <div className="flex flex-col justify-between w-full items-center gap-y-10">
              <h1 className='glow text-8xl text-[#FFFBE9]'>
                {user?.firstname + ' ' + user?.lastname}
              </h1>
              <div className="flex gap-x-2 items-center justify-around pb-5 w-full">
                <div className="flex flex-col justify-center items-center">
                  <h1 className='font-body text-xl  text-[#FFFBE9]'>12</h1>
                  <h1 className='font-body text-[#FFFBE9] text-md'>screenplays</h1>
                </div>
                <div className="flex flex-col justify-center items-center">
                  <h1 className='font-body  text-xl text-[#FFFBE9]'>136</h1>
                  <h1 className='font-body text-[#FFFBE9] text-md'>following</h1>
                </div>
                <div className="flex flex-col justify-center items-center">
                  <h1 className='font-body text-xl  text-[#FFFBE9]'>27</h1>
                  <h1 className='font-body text-[#FFFBE9] text-md'>followers</h1>
                </div>
              </div>
            </div>
          </motion.h1>
