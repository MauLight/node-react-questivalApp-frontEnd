...
export const FilterButton = ({ isOpen, setIsOpen, sortedList, setSortedList }) => {
  ...
  return (
    <div>
      <button className='w-44 px-2 py-5 flex justify-between items-center hover:bg-[#FC4ECF] hover:text-white transition-all duration-200 rounded-t-md' onClick={() => setIsOpen(!isOpen)}>
      ...
      {
        isOpen && (
          <div className="flex flex-col w-44 bg-[#FC4ECF] absolute rounded-b-md justify-start">
