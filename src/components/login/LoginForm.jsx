  ...
  return (
    <div>
      <form onSubmit={handleSubmit} className='flex flex-col items-center gap-y-5 pb-7 px-5 font-body text-sm w-full' >
        ...
        <div className="flex flex-col text-center gap-x-2 w-full">
        ...
        <Link to={'/passwordResetRequest'}><small className='text-white hover:underline pl-2 hover:text-[#FC4ECF] transition-color duration-200'>Forgot password?</small></Link>
