      ...
      <div>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col items-center gap-y-5 pb-7 px-5 font-body text-sm min-w-[15vw]' >
          <div className="flex gap-x-2 w-full">
            <input type='text' className='glass h-8 sm:h-12 p-2 font-body text-sm text-white bg-transparent w-full rounded-md pl-4' value={firstname} onChange={({ target }) => setFirstName(target.value)} placeholder='Firstname' />
            <input type='text' className='glass h-8 sm:h-12 p-2 text-white bg-transparent w-full font-body text-sm rounded-md pl-4' value={lastname} onChange={({ target }) => setLastName(target.value)} placeholder='Lastname' />
          </div>
          <div className="flex gap-y-2 w-full">
            <input type='text' className='glass h-8 sm:h-12 p-2 text-white bg-transparent w-full  rounded-md pl-4' value={email} onChange={({ target }) => setEmail(target.value)} placeholder='Email' />
          </div>
          <div className="flex gap-y-2 w-full">
            <input type='date' className='glass h-8 sm:h-12 p-2 text-white bg-transparent w-full  rounded-md pl-4' value={birthdate} onChange={({ target }) => setBirthdate(target.value)} placeholder='Birthdate' />
          </div>
          <div className="flex gap-x-2 w-full">
            <input type='password' className='glass h-8 sm:h-12 p-2 text-white bg-transparent w-full  rounded-md pl-4' value={password} onChange={({ target }) => setPassword(target.value)} placeholder='Password' />
            <input type='password' className='glass h-8 sm:h-12 p-2 text-white bg-transparent w-full  rounded-md pl-4' value={cpassword} onChange={({ target }) => setCpassword(target.value)} placeholder='Confirm Password' />
          </div>
          <div className="flex gap-y-2 w-full">
