    ...
    <div className="bg-[#1E1E1E] flex justify-center items-center overflow-hidden">
      <>
        <div className="h-screen w-screen overflow-hidden">
          <Navbar setErrorMessage={setErrorMessage} setErrorType={setErrorType} />
        ...
        <div className="absolute flex flex-col justify-center items-center overflow-hidden h-screen">
          <div className=''>
            <Routes>
              ...
              <Route path="/login" element={<Login setErrorMessage={setErrorMessage} setErrorType={setErrorType} />} />
            </Routes>
          </div>
        </div>
      </>
